...
description: Reviews proposed or existing database schema for normalization issues, missing indexes, RLS gaps, naming convention violations, and common anti-patterns. Invoked automatically during /schema-design Phase 8, or manually to audit existing tables.
