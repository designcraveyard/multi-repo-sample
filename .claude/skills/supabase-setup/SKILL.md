---
name: supabase-setup
description: Wire Supabase to both the Next.js web app and SwiftUI iOS app. Use when the user says "add Supabase", "set up the database", "connect to Supabase", or "add auth". Installs the JS client, creates typed client helpers, scaffolds the Swift client, and creates all config files on both platforms.
...
Wire Supabase to both Next.js and SwiftUI in one coordinated workflow.
...
### Phase 6: Update Both CLAUDE.md Files
...
Manual steps required:
  ...
  5. Run: supabase gen types typescript --linked > multi-repo-nextjs/lib/database.types.ts
```
