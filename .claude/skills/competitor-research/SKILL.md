...
description: >
  ...
  fully autonomously inside Claude Cowork — all questions are batched
...
### ⚡ Cowork Note
This skill is optimised for **Claude Cowork** (Claude Desktop autonomous mode). All interactive questions are batched in Phase 0. After Phase 0, the skill runs end-to-end without further prompts. When running in standard Claude Code CLI, the same Phase 0 questions apply — then execution proceeds autonomously.
...
> "I can't access `<URL>` automatically. If you have the Claude Chrome extension installed, open it in your browser, navigate to this page while logged in, then paste the page content or screenshots into the chat and I'll continue."
