...
description: Reference for AdaptiveSplitView usage — when to use it, how to wire list→detail navigation across iOS, web, and Android. Codex-only background knowledge loaded automatically when implementing list→detail screens.
