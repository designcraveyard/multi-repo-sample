...
2. **Check for new patterns** — if this component introduced a new interaction pattern (e.g. a new dismiss mechanism, a new focus management approach), add a note to AGENTS.md under "Component System".
