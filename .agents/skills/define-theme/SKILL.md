...
## Phase 1.5: Aesthetic Archetype — 3 Candidates (Codex synthesis)

**Do NOT ask a question yet.** Based on Phase 1, Codex synthesises THREE directions as a
...
> **3-candidate mode:** The user answers preference questions once. Codex internally
...
If images provided: use Codex vision. Extract per image: color tendencies, typography feel,
