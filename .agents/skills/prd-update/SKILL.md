---
name: prd-update
description: Update PRD documents and AGENTS.md files across the entire workspace when features change or are added. Use when user says "update the PRD", "document this feature", "update AGENTS.md", or at the end of a major development session. Also use after /cross-platform-feature or /new-screen to keep docs current.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# PRD + AGENTS.md Updater
...
- Root: `AGENTS.md`
- Next.js: `multi-repo-nextjs/AGENTS.md`
- iOS: `multi-repo-ios/AGENTS.md`
- Android: `multi-repo-android/AGENTS.md`
- PRDs: `docs/PRDs/`
...
### Phase 2: Audit AGENTS.md Files

Read each AGENTS.md file and compare against actual file structure. Flag:
...
AGENTS.md updates:
  multi-repo-nextjs/AGENTS.md  — [changes made or "up to date"]
  multi-repo-ios/AGENTS.md     — [changes made or "up to date"]
  multi-repo-android/AGENTS.md — [changes made or "up to date"]
  AGENTS.md (root)             — [changes made or "up to date"]
