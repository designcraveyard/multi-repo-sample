...
### Phase 7: Update All AGENTS.md Files

Append to `multi-repo-nextjs/AGENTS.md`:
...
Append to `multi-repo-ios/AGENTS.md`:
...
If Android project exists, append to `multi-repo-android/AGENTS.md`:
